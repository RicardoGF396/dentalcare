...
function Header() {
  ...
  return (
    <div className="relative overflow-x-hidden">
      ...
      <div className="w-full bg-white py-7 px-6 flex justify-between fixed top-0">
      ...
      <div
        className={`w-full h-screen top-0 bottom-0 right-0 bg-[#0000002a] ${
      ...
      <div
        ref={menuRef}
        className={`mobile-menu z-100 fixed transition-all duration-300 right-0 w-[320px] bg-white flex flex-col h-screen top-0 bottom-0 border-l p-8 ${
